...
class Nonet<A, B, C, D, E, F, G, H, I> implements Factory9<A, B, C, D, E, F, G, H, I> {
  const Nonet();

  @override
  Union9<A, B, C, D, E, F, G, H, I> first(A first) => Union9First<A, B, C, D, E, F, G, H, I>(first);

  @override
  Union9<A, B, C, D, E, F, G, H, I> second(B second) => Union9Second<A, B, C, D, E, F, G, H, I>(second);

  @override
  Union9<A, B, C, D, E, F, G, H, I> third(C third) => Union9Third<A, B, C, D, E, F, G, H, I>(third);

  @override
  Union9<A, B, C, D, E, F, G, H, I> fourth(D fourth) => Union9Fourth<A, B, C, D, E, F, G, H, I>(fourth);

  @override
  Union9<A, B, C, D, E, F, G, H, I> fifth(E fifth) => Union9Fifth<A, B, C, D, E, F, G, H, I>(fifth);

  @override
  Union9<A, B, C, D, E, F, G, H, I> sixth(F sixth) => Union9Sixth<A, B, C, D, E, F, G, H, I>(sixth);

  @override
  Union9<A, B, C, D, E, F, G, H, I> seventh(G seventh) => Union9Seventh<A, B, C, D, E, F, G, H, I>(seventh);

  @override
  Union9<A, B, C, D, E, F, G, H, I> eighth(H eighth) => Union9Eighth<A, B, C, D, E, F, G, H, I>(eighth);

  @override
  Union9<A, B, C, D, E, F, G, H, I> ninth(I ninth) => Union9Ninth<A, B, C, D, E, F, G, H, I>(ninth);
}
