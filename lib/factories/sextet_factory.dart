...
class Sextet<A, B, C, D, E, F> implements Factory6<A, B, C, D, E, F> {
  ...
  @override
  Union6<A, B, C, D, E, F> first(A first) => Union6First<A, B, C, D, E, F>(first);

  @override
  Union6<A, B, C, D, E, F> second(B second) => Union6Second<A, B, C, D, E, F>(second);

  @override
  Union6<A, B, C, D, E, F> third(C third) => Union6Third<A, B, C, D, E, F>(third);

  @override
  Union6<A, B, C, D, E, F> fourth(D fourth) => Union6Fourth<A, B, C, D, E, F>(fourth);

  @override
  Union6<A, B, C, D, E, F> fifth(E fifth) => Union6Fifth<A, B, C, D, E, F>(fifth);

  @override
  Union6<A, B, C, D, E, F> sixth(F sixth) => Union6Sixth<A, B, C, D, E, F>(sixth);
}
