...
class Union2First<T, U> implements Union2<T, U> {
  ...
  @override
  R join<R>(R Function(T) mapFirst, R Function(U) mapSecond) => mapFirst(_value);

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is Union2First && runtimeType == other.runtimeType && _value == other._value;
